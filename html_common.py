...
def generate_html(data, split_experience=False):
    ...
    html += f'</tbody></table><div class="publications-note">{edu["publications_note"]}</div></div></div>'

    # --- Page 1: Skills ---
    html += '<div class="skills-box"><div class="skills-label">Skills</div><div class="skills-content">'
    ...
    # --- Page 2: Early Career (only in split mode) ---
    if split_experience:
        html += '<div class="section section-page2"><div class="section-title">Early Career</div>'
        html += render_jobs(data.get('early_experience', []))
        html += '</div>'

    # --- Page 2: Activities ---
    html += '<div class="section section-page2"><div class="section-title">Activities</div>'
